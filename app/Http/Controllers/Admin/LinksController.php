...
class LinksController extends Controller
{
    ...
    public function adminProductReport()
    {
        return view('dashboards.admin.prodcut-reports');
    }
    public function adminSalesReport()
    {
        return view('dashboards.admin.sale-reports');
    }

    public function adminOrderReport()
    {
        return view('dashboards.admin.order-reports');
    }

    public function adminUserReport()
    {
        return view('dashboards.admin.user-reports');
    }
