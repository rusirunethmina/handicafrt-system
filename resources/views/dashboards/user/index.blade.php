...
<div class="container">
@if($user->type =='seller')
<span class="badge badge-primary">Seller Dashboard</span>
<h4>hello, {{$user->name}}  {{$user->type}}<span class="badge badge-secondary">New</span></h4>
   <!--seller start Here-->
  <form>
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        <label for="inputPassword4">Item Category</label>
    ...
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputAddress">Price (Rs.)</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-12">
        <label for="inputCity">Describtion</label>
        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <button type="submit" class="btn btn-primary">Publish Your Prodcut</button>
      </div>
    </div>
  </form>
