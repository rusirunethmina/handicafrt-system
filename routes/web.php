...
Route::group(['middleware' => ['auth', 'isAdmin']], function () {
    Route::get('/admin-dashboard', 'Admin\LinksController@adminDashboard');
    Route::get('/admin-report', 'Admin\LinksController@adminReport');
    Route::get('/admin-product-report', 'Admin\LinksController@adminProductReport');
    Route::get('/admin-sale-report', 'Admin\LinksController@adminSalesReport');
    Route::get('/admin-user-report', 'Admin\LinksController@adminUserReport');
    Route::get('/admin-order-report', 'Admin\LinksController@adminOrderReport');
